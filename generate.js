...
const sanitizeReplacementsResources = {
  ...
  'AJSONobjectconsistingofstringkey-valuepairs,asshowninthefollowingexample:':
    'Map',
  ...
  'Key-valuepairs,withthenameofthelabelasthekeyandthelabelvalueasthevalue':
    'Map',
  ...
  'key-valuepairs': 'Map',
  'referencestoAWS::IAM::RolesCurrently,amaximumofonerolecanbeassignedtoaninstanceprofile':
    'String',
  ...
  users: 'String',
  AppCookieStickinessPolicyobjects:
    'ElasticLoadBalancingAppCookieStickinessPolicyType',
  LBCookieStickinessPolicyobjects:
    'ElasticLoadBalancingLBCookieStickinessPolicyType',
  ElasticLoadBalancingListenerPropertyTypeobjects:
  ...
  'securitygroupsassignedtoyourloadbalancerwithinyourvirtualprivatecloud(VPC)':
    'String'
};
